...
router.get('/me', auth, async (req, res) => {
  try {
    // populate from  the user model at the first parameter, and the  second parameter is wath populate
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    // remove index - from where index to start, 1 - how many elments to remove
